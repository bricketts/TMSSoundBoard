#pragma checksum "C:\Users\Brody\Documents\Visual Studio 2017\Projects\TMSSoundBoard\TMSSoundBoard\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "76578606AEF5E292FA4A5804008DE350"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace TMSSoundBoard
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::TMSSoundBoard.Model.MenuItem dataRoot;
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::TMSSoundBoard.Model.MenuItem);
                ...
                this.Update_((global::TMSSoundBoard.Model.MenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            private void Update_Category(global::TMSSoundBoard.Model.SoundCategory obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj10_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::TMSSoundBoard.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void DataContextChangedHandler(global::Windows.UI.Xaml.FrameworkElement sender, global::Windows.UI.Xaml.DataContextChangedEventArgs args)
            {
                 global::TMSSoundBoard.Model.Sound data = args.NewValue as global::TMSSoundBoard.Model.Sound;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::TMSSoundBoard.Model.Sound was expected.");
                 }
                 this.SetDataRoot(data);
                 this.Update();
            }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::TMSSoundBoard.Model.Sound);
                        if (!removedDataContextHandler)
                        {
                            removedDataContextHandler = true;
                ...
                this.Update_((global::TMSSoundBoard.Model.Sound) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::TMSSoundBoard.Model.Sound newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::TMSSoundBoard.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::TMSSoundBoard.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::TMSSoundBoard.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::TMSSoundBoard.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_MenuItems(global::System.Collections.ObjectModel.ObservableCollection<global::TMSSoundBoard.Model.MenuItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::TMSSoundBoard.Model.Sound> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2:
                {
                    this.ApplicationSplitView = (global::Windows.UI.Xaml.Controls.SplitView)(target);
                }
                break;
            case 3:
                {
            ...
            case 7:
                {
                    this.SoundBoardMediaElement = (global::Windows.UI.Xaml.Controls.MediaElement)(target);
                }
                break;
            case 8:
                {
            ...
            case 13:
                {
                    this.CreateNewMenuItemButton = (global::Windows.UI.Xaml.Controls.Button)(target);
                    #line 49 "..\..\..\MainPage.xaml"
                    ((global::Windows.UI.Xaml.Controls.Button)this.CreateNewMenuItemButton).Click += this.CreateNewMenuItemButton_Click;
                    #line default
                }
                break;
            case 14:
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::TMSSoundBoard.Model.MenuItem) element4.DataContext);
            ...
            case 10:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::TMSSoundBoard.Model.Sound) element10.DataContext);
